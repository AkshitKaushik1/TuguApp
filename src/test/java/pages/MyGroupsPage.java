...
public class MyGroupsPage extends BasePage {
	...
	public void EditSetting() throws InterruptedException {
		...
		.until(ExpectedConditions.elementToBeClickable(grouptype));
		...
		driver.findElement(img1).sendKeys("D:\\TUGU\\flower\\avtar1.jpg");
		
	
		js.executeScript("window.scrollBy(0, 200);");
				
		driver.findElement(img2).sendKeys("D:\\TUGU\\flower\\avtar2.jpg");
		
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		new WebDriverWait(driver, Duration.ofSeconds(30))
		.until(ExpectedConditions.elementToBeClickable(savebtn)).click();
